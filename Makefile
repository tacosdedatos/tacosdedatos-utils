...
check-safety:
	...
	$(BANDIT_COMMAND_FLAG)poetry run bandit -ll -r tacosdedatos_utils/
...
check-style:
	...
	$(MYPY_COMMAND_FLAG)poetry run mypy --config-file setup.cfg tacosdedatos_utils tests/**/*.py
